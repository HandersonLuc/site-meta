...
export default function VistoriaHidrossanitariaPredialPage() {
  return (
    <div className="flex flex-col min-h-screen relative overflow-hidden">
      <section className="bg-black text-white py-16 text-start">
        <div className="container mx-auto px-4">
          <h1 className="text-5xl font-bold">Vistoria Hidrossanitária Predial</h1>
        </div>
      </section>
        ...
        <div className="mx-auto grid max-w-6xl gap-8 md:grid-cols-2">
          ...
          <div>
            <FormularioServico
              ...
              servicoInicial="Vistoria Hidrossanitária Predial"
            />
          </div>
        </div>
      </section>
