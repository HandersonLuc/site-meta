...
export function FormularioServico({
  ...
  const fieldSpacing = isCompact ? "space-y-1" : "space-y-2";
  const controlHeight = isCompact ? "h-9" : "h-10";
  const textareaHeight = isCompact ? "min-h-[60px]" : "min-h-[80px]";
  const coordenacaoKey = getCoordenacaoKey(coordenacao);
  ...
  return (
    <div
      className={cn(
        isHighlight ? "bg-transparent" : "bg-white",
        "rounded-2xl transition-all duration-300",
        isHighlight ? "pt-8" : isCompact ? "p-5" : "p-8",
        className
      )}
    >
      <div className={cn(isCompact ? "mb-3" : "mb-4", "space-y-2")}>
        <h2 className={cn(isCompact ? "text-xl" : "text-2xl", "font-bold text-black")}>{titulo}</h2>
      </div>

      <form className={isCompact ? "space-y-2.5" : "space-y-4"}>
        <div className={fieldSpacing}>
          ...
          <Input
            ...
            className={cn(controlHeight, "rounded-md border border-gray-300 bg-white focus-visible:ring-[#2AD8FF]")}
            required
          />
        </div>
        ...
        <div className={fieldSpacing}>
          ...
          <select
            ...
            className={cn(controlHeight, "w-full rounded-md border border-gray-300 bg-white px-2.5 text-sm text-black focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-[#2AD8FF]/50 disabled:cursor-not-allowed disabled:opacity-50")}
            required
          >
        ...
        <div className={fieldSpacing}>
          ...
          <Textarea
            ...
            className={cn(textareaHeight, "rounded-md border border-gray-300 bg-white focus-visible:ring-[#2AD8FF]")}
            required
          />
        </div>
