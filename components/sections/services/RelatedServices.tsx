...
export function RelatedServices({ services }: RelatedServicesProps) {
  return (
    <section className="bg-[#090E28] text-white py-16">
      <div className="container mx-auto px-4 text-center">
        <h2 className="text-xl font-bold mb-8 border-b-2 border-[#2AD8FF] inline-block">
          SERVIÇOS QUE PODEM TE INTERESSAR
        </h2>

        <div className="flex flex-col items-center gap-12 max-w-4xl mx-auto text-left">
